    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post_date', models.DateField(default=datetime.date(2023, 6, 16))),
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='feed.author')),
                ('content_type', models.ManyToManyField(to='feed.contenttype')),
            ],
        ),
    ]
